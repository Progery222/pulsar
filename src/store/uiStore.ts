...
export type AppMode = 'select' | 'editor' | 'pro' | 'studio' | 'vub' | 'cleaner' | 'tts' | 'dub' | 'funnel' | 'download' | 'cutout' | 'templates' | 'recorder' | 'imgopt' | 'transcribe' | 'aivideo' | 'splitmerge' | 'metadata' | 'settings';

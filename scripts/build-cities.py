...
src = sys.argv[1]
# Только русский алфавит: сербские Њ/Ј/Ђ, украинские І/Ї/Є, казахские Ә/Қ/Ң
# отсекаем — иначе Нью-Йорк выходит «Њу Јорк», а рядом с Ошем — «Ошновіє».
...
def ru_name(alts: str) -> str:
    ...
    # русское по алфавиту — болгарское или сербское на русских буквах не
    # отличить, но таких единицы.
    for a in alts.split(','):
        a = a.strip()
